...
> Please help me install DotAIOS by following https://github.com/filocosta46/dotaios/blob/v2.0.4/INSTALL.md — the “If an AI assistant is helping you” section. Preview every change, ask me only about choices I can evaluate, verify it, and show me my one AIOS folder.
...
The package is [`dotaios` on npm](https://www.npmjs.com/package/dotaios), published from the [`filocosta46/dotaios` repository](https://github.com/filocosta46/dotaios). Release `2.0.4` maps to Git tag [`v2.0.4`](https://github.com/filocosta46/dotaios/releases/tag/v2.0.4).

These commands inspect registry provenance and packaged contents without running DotAIOS setup:

```sh
npm view dotaios@2.0.4 version dist.integrity dist.tarball gitHead _npmUser.name

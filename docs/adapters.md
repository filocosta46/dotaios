...
```bash
npx dotaios@2.0.11 skills probe --client codex --path ~/aios --dry-run
npx dotaios@2.0.11 skills probe --client codex --path ~/aios --run \
...
```bash
npx dotaios@2.0.11 attach /path/to/project --path ~/aios
npx dotaios@2.0.11 attach /path/to/project --path ~/aios --dry-run
```

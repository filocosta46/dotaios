...
The agent should then run the preview below. If you are recovering
...
- Existing `~/aios`: do not delete it. Run
  `npx dotaios@2.0.13 doctor` and inspect the folder.
...
- Agent refusal: use another local agent that can review and run commands, or
  follow the same preview and setup commands yourself.

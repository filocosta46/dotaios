...
```bash
npx dotaios@2.0.15 connect google --dry-run
npx dotaios@2.0.15 google doctor
npx dotaios@2.0.15 google setup
npx dotaios@2.0.15 connect google --status
npx dotaios@2.0.15 connect google
npx dotaios@2.0.15 google status
npx dotaios@2.0.15 google inbox
npx dotaios@2.0.15 google gmail search "from:alice@example.com newer_than:7d"
npx dotaios@2.0.15 google gmail read <message-id>
npx dotaios@2.0.15 google agenda --today
npx dotaios@2.0.15 google calendar prep --today
npx dotaios@2.0.15 google drive --page-size 5
npx dotaios@2.0.15 google drive find "budget"
```
...
2. Run `npx dotaios@2.0.15 google setup`.
3. If `gcloud` is available, either run `gws auth setup` manually or run `npx dotaios@2.0.15 google setup --run`.
...
6. Run `npx dotaios@2.0.15 connect google`.
...
npx dotaios@2.0.15 google agenda --today
npx dotaios@2.0.15 google calendar prep --today
npx dotaios@2.0.15 google agenda --week
npx dotaios@2.0.15 google drive --page-size 10
npx dotaios@2.0.15 google drive find "budget"
```

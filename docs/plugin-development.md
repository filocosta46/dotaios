...
Plugins are optional local extensions. In v1, DotAIOS supports installing a plugin from a local directory. A plugin contains a `manifest.json`, a `SKILL.md`, and optional source code.

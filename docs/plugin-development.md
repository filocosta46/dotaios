...
```bash
npx dotaios@2.0.14 install ./reviewed-repo --dry-run
npx dotaios@2.0.14 install ./reviewed-repo
npx dotaios@2.0.14 install ./reviewed-repo --subdir packages/my-plugin --dry-run
```

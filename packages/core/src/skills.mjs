...
export function renderSkillsIndex(skills) {
  const lines = [
    ...
    // Not a bare name: the documented install links no `dotaios` binary, so the
    // reader of this generated file could not run what it names.
    "`npx dotaios activate` or install/remove a skill.",
    "",
